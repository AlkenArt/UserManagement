/**
 * UpdateGroupParametersType.java
 *
...
public class UpdateGroupParametersType  implements java.io.Serializable {
    private com.aptilo.schemas.account.provisioning.UpdateParameterType[] parameter;

    private java.lang.String name;  // attribute

    public UpdateGroupParametersType() {
    }
    ...
    /**
     * Gets the parameter value for this UpdateGroupParametersType.
     * 
     * @return parameter
     */
    ...
    /**
     * Sets the parameter value for this UpdateGroupParametersType.
     * 
     * @param parameter
     */
    ...
    /**
     * Gets the name value for this UpdateGroupParametersType.
     * 
     * @return name
     */
    ...
    /**
     * Sets the name value for this UpdateGroupParametersType.
     * 
     * @param name
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateGroupParametersType)) return false;
        UpdateGroupParametersType other = (UpdateGroupParametersType) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateGroupParametersType.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.aptilo.com/account/provisioning", "updateGroupParametersType"));
